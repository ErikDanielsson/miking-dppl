lam st.
    ...
    lam st922.
      lam a48.
        lam b12.
          ...
          in
          match
            p_subApply st933 simpleStoreSubmodel (simpleInit {}) x1478 x1480
          with
            (st934, x1481)
          in
        ...
        lam mtx213.
          lam x1241.
            lam x1242.
              ...
              in
              match
                p_subApply st829 simpleStoreSubmodel (simpleInit {}) x1273 x1275
              with
                (st830, x1276)
              in
                    ...
                    lam nEvents31.
                      lam nhosts51.
                        lam modelParams1.
                          ...
                          in
                          match
                            p_subApply st137 simpleStoreSubmodel (simpleInit {}) x172 x174
                          with
                            (st138, x175)
                          in
        ...
        lam nodeLabel51.
          lam x915.
            ...
            with
              (st589, x920)
            in
            p_assume st589 simpleStoreAssume x920
  in
  recursive
    let rec15 =
      lam st272.
                        ...
                        (lam st277.
                           lam x410.
                             match
                               ...
                               in
                               match p_assume st286 simpleStoreAssume x425 with (st287, nextState11)
                               in
                               match
                                 p_traverseSeq
                                   st287
                               ...
                               in
                               match p_assume st292 simpleStoreAssume x434 with (st293, x435)
                               in
                               match
                                 p_map
                                   st293
                        ...
                        (lam st304.
                           lam x454.
                             match
                               ...
                               in
                               match p_assume st314 simpleStoreAssume x471 with (st315, nextState12)
                               in
                               match
                                 p_traverseSeq
                                   st315
                               ...
                               in
                               match p_assume st320 simpleStoreAssume x480 with (st321, x481)
                               in
                               match
                                 p_map
                                   st321
              ...
              lam nodeLabel12.
                lam modelParams31.
                  lam x894.
                    ...
                    in
                    match p_assume st577 simpleStoreAssume x904 with (st578, x905)
                    in
                    match
                      p_map
                        st578
              ...
              lam nodeLabel11.
                lam modelParams3.
                  lam x874.
                    ...
                    in
                    match p_assume st565 simpleStoreAssume x884 with (st566, x885)
                    in
                    match
                      p_map
                        st566
                                       ...
                                       p_bind
                                         ...
                                         (lam st400.
                                            lam x628.
                                              ...
                                              in
                                              match
                                                p_subApply st408 simpleStoreSubmodel (simpleInit {}) x636 x638
                                              with
                                                (st409, x639)
                                              in
                                     ...
                                     p_bind
                                       ...
                                       (lam st460.
                                          lam x725.
                                            ...
                                            in
                                            match
                                              p_subApply st468 simpleStoreSubmodel (simpleInit {}) x733 x735
                                            with
                                              (st469, x736)
                                            in
  ...
  in
  match
    p_assume st498 simpleStoreAssume (p_pure (mkExponential 10.))
  with
    (st499, mu)
  in
  match
    p_assume st499 simpleStoreAssume (p_pure (mkExponential 1.))
  with
    (st500, beta)
  in
  match
