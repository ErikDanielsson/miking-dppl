lam st.
    ...
    lam st942.
      lam a48.
        lam b12.
          ...
          in
          match
            p_subApply st953 simpleStoreSubmodel (simpleInit {}) x1478 x1480
          with
            (st954, x1485)
          in
        ...
        lam mtx213.
          lam x1265.
            lam x1266.
              ...
              in
              match
                p_subApply st845 simpleStoreSubmodel (simpleInit {}) x1297 x1299
              with
                (st846, x1300)
              in
                    ...
                    lam nEvents3.
                      lam nhosts5.
                        lam modelParams.
                          ...
                          in
                          match
                            p_subApply st115 simpleStoreSubmodel (simpleInit {}) x138 x140
                          with
                            (st116, x144)
                          in
                    ...
                    lam nEvents31.
                      lam nhosts51.
                        lam modelParams1.
                          ...
                          in
                          match
                            p_subApply st137 simpleStoreSubmodel (simpleInit {}) x175 x177
                          with
                            (st138, x178)
                          in
        ...
        lam nodeLabel51.
          lam x941.
            ...
            with
              (st608, x946)
            in
            p_assume st608 simpleStoreAssume x946
  in
  recursive
    let rec15 =
      lam st272.
                        ...
                        (lam st280.
                           lam x415.
                             match
                               ...
                               in
                               match p_assume st289 simpleStoreAssume x430 with (st290, nextState11)
                               in
                               match
                                 p_traverseSeq
                                   st290
                               ...
                               in
                               match p_assume st295 simpleStoreAssume x439 with (st296, x440)
                               in
                               match
                                 p_map
                                   st296
                        ...
                        (lam st307.
                           lam x459.
                             match
                               ...
                               in
                               match p_assume st317 simpleStoreAssume x476 with (st318, nextState12)
                               in
                               match
                                 p_traverseSeq
                                   st318
                               ...
                               in
                               match p_assume st323 simpleStoreAssume x485 with (st324, x486)
                               in
                               match
                                 p_map
                                   st324
              ...
              lam nodeLabel13.
                lam modelParams32.
                  lam x922.
                    ...
                    in
                    match p_assume st595 simpleStoreAssume x931 with (st596, x932)
                    in
                    match
                      p_map
                        st596
              ...
              lam nodeLabel12.
                lam modelParams31.
                  lam x902.
                    ...
                    in
                    match p_assume st583 simpleStoreAssume x912 with (st584, x913)
                    in
                    match
                      p_map
                        st584
                                   ...
                                   p_bind
                                     ...
                                     (lam st552.
                                        lam x853.
                                          ...
                                          in
                                          match
                                            p_subApply st560 simpleStoreSubmodel (simpleInit {}) x861 x863
                                          with
                                            (st561, x864)
                                          in
                                       ...
                                       p_bind
                                         ...
                                         (lam st400.
                                            lam x630.
                                              ...
                                              in
                                              match
                                                p_subApply st408 simpleStoreSubmodel (simpleInit {}) x638 x640
                                              with
                                                (st409, x641)
                                              in
  ...
  in
  match
    p_assume st449 simpleStoreAssume (p_pure (mkExponential 10.))
  with
    (st450, mu)
  in
  match
    p_assume st450 simpleStoreAssume (p_pure (mkExponential 1.))
  with
    (st451, beta)
  in
  match
  ...
  let st519 =
    p_weight
      st518 simpleStoreWeight (/-temp-/lam x802.
         x802) x795
  in
  let foo4 = {} in
