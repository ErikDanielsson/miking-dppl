...
lam st.
          ...
          lam n7.
            match
              p_map
                st910
                (lam x1430.
                   externalExtArrMakeUninit kind (muli m4 x1430))
                n7
            with
              (st911, x1431)
            in
            (st911, { arr = x1431, n = n7, m = m4 })
  in
  let matGetExn =
    lam a701.
      lam i201.
          ...
          lam j2.
            match
              p_map
                ...
                (lam x1425.
                   lam x1426.
                     match x1425 with {arr = #var"X67"}
                     in
                     externalExtArrGet #var"X67" x1426)
                a70
            with
              (st908, x1427)
            in
      ...
      lam a64.
        ...
        match
          p_map
            ...
            (lam x1415.
               lam x1416.
                 tmOpaque (let b24 = extArrMakeUninit (externalExtArrKind x1415.arr) x1416
                  in
                  let #var"20" = externalCblasCopy x1416 x1415.arr 1 b24 1 in
                  b24))
            a64
        with
          (st902, x1417)
        ...
        in
        match
          p_map st903 (lam x1421.
               x1421.n) a64
        with
          (st904, x1422)
        in
        match p_apply st904 x1420 x1422 with (st905, x1423)
        in
        match p_apply st905 x1417 x1423 with (st906, x1424)
        in
        p_apply st906 x1410 x1424
  in
    ...
    lam st886.
      lam a52.
        lam b13.
            ...
            p_map
              ...
              (lam x1373.
                 lam x1374.
                   lam st888.
                     match
                       match eqi x1373 x1374 with true
                       then
                         match
                           p_map
                             st888
                           ...
                           p_map
                             ...
                             (lam x1377.
                                lam x1378.
                                  lam x1379.
                                    lam x1380.
                                      tmOpaque (let c210 = matMakeUninit (externalExtArrKind x1380.arr) x1377 x1378
                                       in
                                       let #var"13" =
                                         externalCblasGemm
                                           cblasRowMajor
                         ...
                         with
                           (st891, x1387)
                         in
                         match p_apply st891 x1385 x1387 with (st892, x1388)
                         in
                         match p_apply st892 x1388 a52 with (st893, x1389)
                         in
                         match p_apply st893 x1389 b13 with (st894, x1390)
                         in
                         (st894, Right
                           x1390)
                       else
          ...
          in
          match
            p_map st896 (lam x1399.
                 x1399.m) b13
          with
            (st897, x1400)
          in
          match
            p_subApply st897 simpleStoreSubmodel (simpleInit {}) x1398 x1400
          with
            (st898, x1405)
          in
          match p_join st898 x1405 with (st899, x1406)
          in
          p_map
            st899
            (lam x1407.
               match x1407 with Left carried73
               then
                 error (matErrorToString carried73)
               else match x1407 with Right carried74
               in
               carried74)
            x1406
  in
  let exp1 = lam x1571.
      externalExp x1571 in
  let log1 = lam x1562.
      externalLog x1562 in
  let log11 =
    lam st885.
      lam x1561.
        p_map st885 (lam x1370.
             externalLog x1370) x1561
  in
  let cons1 = lam e24.
      lam s103.
        cons e24 s103 in
  let cons11 =
    lam st881.
      lam e23.
        lam s102.
          match e23 with Event1 x1356
          in
          match x1356 with {toState = x1357}
          in
          match
            p_map
              st881
              (lam x1358.
                 lam x1359.
                   match x1356 with {host = x1360}
                   in
                   match x1356 with {eventTime = x1365}
                   in
                   Event1
                     { host = x1360,
                       toState = x1358,
          ...
          with
            (st882, x1366)
          in
          match x1356 with {fromState = x1367}
          in
          match p_apply st882 x1366 x1367 with (st883, x1368)
          in
          match p_map st883 cons x1368 with (st884, x1369)
          in
          p_apply st884 x1369 s102
  in
  let cons12 = lam e22.
      lam s101.
        cons e22 s101 in
  ...
  let paste0 =
    lam l52.
      match l52 with [ _ ] ++ _
      then
        match splitAt l52 1 with {#label"1" = x1355}
        in
        rec2 (concat "" (get l52 0)) x1355
      else match l52 with ""
      in
      ""
  in
      ...
      lam l51.
        ...
        then
          ...
          with
            (st877, x1346)
          in
          match p_map st877 concat x1346 with (st878, x1347)
          in
          match p_apply st878 x1347 (get l51 0) with (st879, x1348)
          in
          match splitAt l51 1 with {#label"1" = x1349}
          in
          rec22 st879 x1348 x1349
        else match l51 with ""
        in
        p_traverseSeq
          st875
      ...
      lam l5.
        ...
        then
          ...
          with
            (st871, x1340)
          in
          match p_map st871 concat x1340 with (st872, x1341)
          in
          match p_apply st872 x1341 (get l5 0) with (st873, x1342)
          in
          match splitAt l5 1 with {#label"1" = x1343}
          in
          rec23 st873 x1342 x1343
        else match l5 with ""
        in
        p_traverseSeq
          st869
  ...
  let length12 = lam l32.
      length l32 in
  let length13 = lam st868.
      lam l31.
        p_map st868 length l31
  in
  let anon1 =
    lam x1336.
      lam x1337.
        lam x1338.
          match x1338 with true
          then
            snoc x1336 (addi x1337 1)
          else
            x1336
  in
  recursive
      ...
      lam s72.
        ...
        then
          ...
          with
            (st866, x1334)
          in
          work1 st866 x1334 (addi 0 1) rest3
        else
          p_traverseSeq
            st865
            (lam st867.
               ...
               let work32 =
                 lam i213.
                   ...
                   then
                     ...
                     let #var"2149" = externalExtArrSet a752 i213 (get data1 i213)
                     in
                     work32 (addi i213 1)
             in
          ...
          lam data.
            ...
            match
              p_map
                st861
                (lam x1325.
                   tmOpaque (let len1 = length x1325 in
                      ...
                      let work31 =
                        lam i212.
                          ...
                          then
                            ...
                            let #var"2148" = externalExtArrSet a751 i212 (get x1325 i212)
                            in
                            work31 (addi i212 1)
                    in
            ...
            p_map
              st862
              (lam x1327.
                 match eqi (muli rows cols11) (externalExtArrLength x1327) with true
                 then
                   { arr = x1327, n = cols11, m = rows }
                 else
                   error "matFromArrExn: dimensions mismatch")
              x1326
  in
  let mtxGet =
    lam st858.
      lam row13.
        lam col2.
          lam mtx62.
            matGetExn1 st858 mtx62 (subi row13 1) (subi col2 1)
  in
  let mtxGet1 =
    lam st852.
      lam row12.
          ...
          lam mtx61.
            match
              p_map
                ...
                (lam x1306.
                   lam x1307.
                     match x1306 with {arr = #var"X48"}
                     in
                     externalExtArrGet #var"X48" x1307)
                mtx61
            with
              (st853, x1308)
            in
            match
              p_map st853 (lam x1309.
                   subi x1309 1) row12
            with
              (st854, x1310)
            in
            match
              p_map
                ...
                (lam x1314.
                   lam x1315.
                     addi (muli x1314 x1315) (subi col1 1))
                x1310
            with
              (st855, x1316)
            in
            match
              p_map st855 (lam x1317.
                   x1317.n) mtx61
            with
              (st856, x1318)
            in
            match p_apply st856 x1316 x1318 with (st857, x1319)
            in
            p_apply st857 x1308 x1319
  in
  let mtxGet2 =
    lam st844.
      lam row11.
          ...
          lam mtx6.
            match
              p_map
                ...
                (lam x1291.
                   lam x1292.
                     match x1291 with {arr = #var"X47"}
                     in
                     externalExtArrGet #var"X47" x1292)
                mtx6
            with
              (st845, x1293)
            in
            match
              p_map st845 (lam x1294.
                   subi x1294 1) row11
            with
              (st846, x1295)
            in
            match
              p_map
                ...
                (lam x1296.
                   lam x1297.
                     lam x1298.
                       addi (muli x1296 x1297) x1298)
                x1295
            with
              (st847, x1299)
            in
            match
              p_map st847 (lam x1300.
                   x1300.n) mtx6
            with
              (st848, x1301)
            in
            match p_apply st848 x1299 x1301 with (st849, x1302)
            in
            match
              p_map st849 (lam x1303.
                   subi x1303 1) col
            with
              (st850, x1304)
            in
            match p_apply st850 x1302 x1304 with (st851, x1305)
            in
            p_apply st851 x1293 x1305
  in
  let anon2 =
    lam new5.
      lam mtx55.
        lam row5.
          lam x1289.
            lam x1290.
              ...
              externalExtArrSet
                #var"X45"
                (addi (muli 0 #var"X46") x1289)
                (matGetExn mtx55 (subi row5 1) (subi x1290 1))
  in
  let anon3 =
    lam st841.
      lam new4.
              ...
              lam x1283.
                ...
                match
                  p_map
                    ...
                    (lam x1284.
                       lam x1285.
                         externalExtArrSet x1284 x1285 (matGetExn mtx54 (subi row4 1) (subi x1283 1)))
                    #var"X43"
                with
                  (st842, x1286)
                in
                ...
                match
                  p_map
                    st842
                    (lam x1287.
                       addi (muli 0 x1287) x1282)
                    #var"X44"
                with
                  (st843, x1288)
                in
                p_apply st843 x1286 x1288
  in
  let anon4 =
    lam st835.
      lam new3.
              ...
              lam x1270.
                ...
                match
                  p_map
                    ...
                    (lam x1271.
                       lam x1272.
                         lam x1273.
                           externalExtArrSet x1271 x1272 x1273)
                    #var"X39"
                with
                  (st836, x1274)
                in
                ...
                match
                  p_map
                    st836
                    (lam x1275.
                       addi (muli 0 x1275) x1269)
                    #var"X40"
                with
                  (st837, x1276)
                in
                match p_apply st837 x1274 x1276 with (st838, x1277)
                in
                match
                  p_map st838 (lam x1278.
                       subi x1278 1) row3
                with
                  (st839, x1279)
                in
                match
                  p_map
                    ...
                    (lam x1280.
                       ...
                       in
                       externalExtArrGet #var"X41" (addi (muli x1280 #var"X42") (subi x1270 1)))
                    x1279
                with
                  (st840, x1281)
                in
                p_apply st840 x1277 x1281
  in
  recursive
    let rec1 =
      lam c2.
      ...
      lam mtx51.
        lam row1.
          lam cols1.
            ...
            in
            match p_map st825 length cols1 with (st826, x1260)
            in
            match
              matMakeUninit1 st826 (externalExtArrKind #var"X37") 1 x1260
            with
              (st827, new1)
            in
            match
                   ...
                   lam x1261.
                     match
                       match x1261 with [ _,
                           _ ] ++ _
                       then
                         match anon3 st828 new1 mtx51 row1 0 (get x1261 0) with (st829, x1262)
                         in
                         match splitAt x1261 1 with {#label"1" = x1263}
                         in
                         match rec11 st829 new1 mtx51 row1 (addi 0 1) x1263 with (st830, x1264)
                         in
                         (st830, cons x1262 x1264)
                       else match x1261 with [ e18 ]
                       then
                         match splitAt x1261 1 with {#label"1" = x1265}
                         in
                         let slice17 = x1265 in
                         match anon3 st828 new1 mtx51 row1 0 e18 with (st831, x1266)
                         in
                         (st831, [ x1266 ])
                       else match x1261 with ""
                       in
                       (st828, "")
                     with
                       (st832, x1267)
      ...
      lam mtx5.
        lam row.
          lam cols.
            ...
            in
            match p_map st815 length cols with (st816, x1251)
            in
            match
              matMakeUninit1 st816 (externalExtArrKind #var"X36") 1 x1251
            with
              (st817, new)
            in
            match
                   ...
                   lam x1252.
                     match
                       match x1252 with [ _,
                           _ ] ++ _
                       then
                         match anon4 st818 new mtx5 row 0 (get x1252 0) with (st819, x1253)
                         in
                         match splitAt x1252 1 with {#label"1" = x1254}
                         in
                         match rec12 st819 new mtx5 row (addi 0 1) x1254 with (st820, x1255)
                         in
                         (st820, cons x1253 x1255)
                       else match x1252 with [ e17 ]
                       then
                         match splitAt x1252 1 with {#label"1" = x1256}
                         in
                         let slice16 = x1256 in
                         match anon4 st818 new mtx5 row 0 e17 with (st821, x1257)
                         in
                         (st821, [ x1257 ])
                       else match x1252 with ""
                       in
                       (st818, "")
                     with
                       (st822, x1258)
  ...
  let mtxSclrMul =
    lam st807.
      lam scalar.
        lam mtx41.
          match
            p_map st807 (lam x1238.
                 x1238.m) mtx41
          with
            (st808, m21)
          in
          match
            p_map st808 (lam x1239.
                 x1239.n) mtx41
          with
            (st809, n51)
          in
            ...
            p_map
              ...
              (lam x1240.
                 lam x1241.
                   lam x1242.
                     lam x1243.
                       tmOpaque (let b151 = matMakeUninit (externalExtArrKind x1243.arr) x1240 x1241
                        in
                        let #var"141" = externalCblasCopy x1242 x1243.arr 1 b151.arr 1
                        in
                        let #var"151" = externalCblasScal x1242 scalar b151.arr 1 in
                        b151))
              m21
          with
            (st810, x1244)
          in
          match p_apply st810 x1244 n51 with (st811, x1245)
          in
          match
            p_map
              st811
          ...
          with
            (st812, x1248)
          in
          match p_apply st812 x1248 n51 with (st813, x1249)
          in
          match p_apply st813 x1245 x1249 with (st814, x1250)
          in
          p_apply st814 x1250 mtx41
  in
  let mtxTrans =
    lam st806.
      lam mtx3.
        p_map
          st806
          (lam x1237.
             tmOpaque (let b18 = matMakeUninit (externalExtArrKind x1237.arr) x1237.n x1237.m
              in
              let #var"17" = matTranposeNoAlloc x1237 b18 in
              b18))
          mtx3
  in
  let anon5 =
          ...
          lam x1228.
            match
              p_map
                ...
                (lam x1229.
                   lam x1230.
                     match x1229 with {arr = #var"X35"}
                     in
                     externalExtArrSet #var"X35" x1228 x1230)
                mtx241
            with
              (st802, x1231)
            in
            match
              p_map st802 (lam x1232.
                   x1232.arr) mtx112
            with
              (st803, x1233)
            in
            match extArrGetExn st803 x1233 x1228 with (st804, x1234)
            in
            match
              p_map
                st804
                (lam x1235.
                   match gtf x1235 0. with true
                   then
                     x1235
                   else
                     0.)
            ...
            lam x1172.
              match
                p_map
                  ...
                  (lam x1173.
                     lam x1174.
                       lam x1175.
                         match x1173 with {arr = #var"X33"}
                         in
                         externalExtArrSet #var"X33" x1174 x1175)
                  mtx212
              with
                (st775, x1176)
              in
              match
                p_map
                  st775
                  (lam x1177.
                     match x1177 with {n = #var"X34"}
                     in
                     addi (muli x1171 #var"X34") x1172)
                  mtx212
              with
                (st776, x1178)
              in
              match p_apply st776 x1176 x1178 with (st777, x1179)
              in
              match matGetExn1 st777 mtx82 x1171 x1172 with (st778, x1180)
              in
              match
                p_map
                  st778
              ...
              in
              match
                p_map st779 (lam x1184.
                     x1184.m) mtx82
              with
                (st780, x1185)
              in
              match
                p_map st780 (lam x1186.
                     subi x1186 1) x1185
              with
                (st781, x1187)
              in
              match
                p_map
                  st781
                  (lam x1188.
                     match geqi x1188 0 with true
                     then
                       rec3 1. (subi x1188 1) (cons (anon 1. x1188) "")
                     else
                       "")
                  x1187
              with
              ...
              match
                p_map
                  st782
                  (lam x1190.
                     tmOpaque (let len = length x1190 in
                        ...
                        let work3 =
                          lam i211.
                            ...
                            then
                              ...
                              let #var"2147" = externalExtArrSet a75 i211 (get x1190 i211) in
                              work3 (addi i211 1)
                      in
                ...
                p_map
                  ...
                  (lam x1193.
                     lam x1194.
                       lam st785.
                         let x1195 =
                           match eqi (muli x1193 1) x1194 with true
                           then
                             { arr = a66, n = 1, m = x1193 }
                           else
                             let x1200 = error "matFromArrExn: dimensions mismatch" in
                             match x1200 with {arr = x1205}
                             in
                             match x1200 with {n = x1206}
                             in
                             match x1200 with {m = x1207}
                             in
                             { arr = p_pure x1205, n = x1206, m = x1207 }
                         in
                         match x1195 with {arr = x1196}
                         in
                         p_map
                           st785
                           (lam x1197.
                              match x1195 with {n = x1198}
                              in
                              match x1195 with {m = x1199}
                              in
                              { arr = x1197, n = x1198, m = x1199 })
                           x1196)
                  x1192
              with
                (st786, x1208)
              ...
              match
                p_map
                  st786
                  (lam x1209.
                     externalExtArrLength x1209)
                  a66
              with
                (st787, x1210)
              in
              match
                p_subApply st787 simpleStoreSubmodel (simpleInit {}) x1208 x1210
              with
                (st788, x1211)
              in
              match p_join st788 x1211 with (st789, x1212)
              in
              match matMulExn st789 mtx82 x1212 with (st790, x1213)
              in
              match
                p_map
                  st790
                  (lam x1214.
                     match x1214 with {arr = field26, n = field27, m = field28}
                     in
                     field26)
                  x1213
              with
              ...
              match
                p_map
                  st791
                  (lam x1215.
                     externalExtArrLength x1215)
                  a73
              with
                (st792, x1216)
              in
              match
                p_map st792 (lam x1217.
                     subi x1217 1) x1216
              with
                (st793, x1218)
              in
              match
                p_bind
                  ...
                  (lam st794.
                     lam x1219.
                       match
                         match geqi x1219 0 with true
                         then
                           match
                             p_map
                               st794
                               (lam x1220.
                                  externalExtArrGet x1220 x1219)
                               a73
                           with
                             (st795, x1221)
                           in
                           rec31 st795 a73 (subi x1219 1) (cons x1221 "")
                         else
                           (st794, "")
                       with
                         (st796, x1222)
              ...
              match
                p_map
                  st798 (lam x1225.
                     get x1225 x1171) x1224
              with
                (st799, x1226)
              in
              match p_apply st799 x1183 x1226 with (st800, x1227)
              in
              p_apply st800 x1179 x1227
  in
  recursive
    let rec41 =
      lam st22.
        ...
        lam mtx211.
          lam x1167.
            ...
            p_subMap
              ...
              (lam x1170.
                 lam st772.
                   match geqi 0 x1170 with true
                   then
                     (st772, {})
                   else match anon6 st772 mtx81 mtx211 #frozen"x1167" 0 with (st773, #var"6")
                   in
                   rec41 st773 mtx81 mtx211 #frozen"x1167" x1170 (addi 0 1))
              x1169
  in
  recursive
    let rec42 =
      ...
      lam mtx2.
        match
          p_map
            ...
            (lam x1148.
               lam x1149.
                 match x1148 with {m = #var"X28"}
                 in
                 match eqi #var"X28" x1149 with true
                 then
                   match x1148 with {m = #var"X29"}
                   in
                   match x1148 with {n = #var"X30"}
                   in
                   match x1148 with {arr = #var"X31"}
                   in
                   Right
                     { x1148 with arr = externalMatExp #var"X29" #var"X30" #var"X31" }
                 else
                   Left
                     (NotSquare
                        {}))
        ...
        in
        match
          p_map st754 (lam x1152.
               x1152.n) mtx2
        with
          (st755, x1153)
        in
        match p_apply st755 x1150 x1153 with (st756, x1154)
        in
        match
          p_map
            st756
            (lam x1155.
               match x1155 with Left carried70
               then
                 match carried70 with NotSquare carried71
                 in
                 error "Not square"
               else match x1155 with Right carried72
               in
               carried72)
            x1154
        with
          (st757, mtx111)
        in
        match matCopy st757 mtx111 with (st758, mtx24)
        in
        match
          p_map
            st758
        ...
        in
        match
          p_map st759 (lam x1159.
               x1159.n) mtx111
        with
          (st760, x1160)
        in
        match p_apply st760 x1158 x1160 with (st761, x1162)
        in
        match
          p_subMap
            st761
            ...
            (lam x1163.
               lam st762.
                 match geqi 0 x1163 with true
                 then
                   (st762, {})
                 else match anon5 st762 mtx111 mtx24 0 with (st763, #var"4")
                 in
                 rec4 st763 mtx111 mtx24 x1163 (addi 0 1))
            x1162
        with
          (st764, #var"12")
        in
        let mtx8 = mtx24 in
        match matCopy st764 mtx8 with (st765, mtx21)
        in
        match
          p_map st765 (lam x1164.
               x1164.m) mtx8
        with
          (st766, x1165)
        in
        match
          p_subMap
            ...
            (lam x1166.
               lam st767.
                 match geqi 0 x1166 with true
                 then
                   (st767, {})
                 else match anon7 st767 mtx8 mtx21 0 with (st768, #var"5")
                 in
                 rec42 st768 mtx8 mtx21 x1166 (addi 0 1))
            x1165
        with
          (st769, #var"11")
        in
    ...
    lam st751.
      lam e31.
        p_map
          st751
          (lam x1147.
             match x1147 with Left carried68
             then
               error (matErrorToString carried68)
             else match x1147 with Right carried69
             in
             carried69)
          e31
  in
    ...
    lam st738.
      lam a361.
        lam b41.
          ...
          in
          match
            p_map st739 (lam x1127.
                 x1127.m) b41
          with
            (st740, x1128)
          in
          match p_apply st740 x1126 x1128 with (st741, x1129)
          in
          match
            p_map
              st741
          ...
          in
          match
            p_map st742 (lam x1133.
                 x1133.n) b41
          with
            (st743, x1134)
          in
          match p_apply st743 x1132 x1134 with (st744, x1135)
          in
          match and1 st744 x1129 x1135 with (st745, x1136)
          in
          match
            p_bind
              st745
                     ...
                     then
                       match
                         p_map
                           ...
                           (lam x1138.
                              lam x1139.
                                tmOpaque (let c311 = matMakeUninit (externalExtArrKind x1138.arr) x1138.m x1138.n
                                 in
                                 let #var"161" = matElemMulNoAlloc x1138 x1139 c311 in
                                 c311))
                           a361
                       with
                         (st747, x1140)
                       in
                       match p_apply st747 x1140 b41 with (st748, x1142)
                       in
                       (st748, Right
                         x1142)
                     else
      ...
      lam mtx1.
        ...
        match
          p_bind
            ...
            (lam st732.
               lam x1114.
                 match lti 0 x1114 with true
                 then
                   match mtx1 with {arr = #var"X19"}
                   in
                   match extArrGetExn st732 #var"X19" 0 with (st733, x1115)
                   in
                   match
                     p_map
                       st733
                   ...
                   with
                     (st734, x1117)
                   in
                   work21 st734 x1114 mtx1 (addi 0 1) x1117
                 else
                   (st732, p_pure 0.))
            x1113
        with
        ...
        match
          p_map
            ...
            (lam x1122.
               ...
               in
               int2float (muli #var"X21" x1122))
            #var"X20"
        with
          (st737, x1123)
        in
        p_apply st737 x1121 x1123
  in
  let isNaN1 =
    lam r21.
  ...
  let mtx3ToSeq =
    lam st717.
      lam mtx.
        lam i121.
          match mtxGet st717 i121 1 mtx with (st718, p111)
          in
          match mtxGet st718 i121 2 mtx with (st719, p210)
          in
          match mtxGet st719 i121 3 mtx with (st720, p310)
          in
          match
            p_map
              st720
              (lam x1094.
                 lam x1095.
                   lam x1096.
                     addf (addf x1094 x1095) x1096)
              p111
          with
            (st721, x1097)
          in
          match p_apply st721 x1097 p210 with (st722, x1098)
          in
          match p_apply st722 x1098 p310 with (st723, s51)
          in
          match
            p_map
              st723
          ...
          with
            (st724, x1102)
          in
          match p_apply st724 x1102 s51 with (st725, x1103)
          in
          match
            p_map
              st725
          ...
          with
            (st726, x1106)
          in
          match p_apply st726 x1106 s51 with (st727, x1107)
          in
          match
            p_map
              st727
          ...
          with
            (st728, x1110)
          in
          match p_apply st728 x1110 s51 with (st729, x1111)
          in
          (st729, [ x1103,
            x1107,
            x1111 ])
      ...
      lam x1471.
        lam samplingProb1.
          lam nhosts8.
            ...
            match s226 with [ _ ] ++ _
            then
              let x1085 = get s226 0 in
              match mtx3ToSeq st712 samplingProb1 x1085 with (st713, params1)
              in
              match
                p_bind
                  st713
                  ...
                  (lam st714.
                     lam x1086.
                       match
                         match geqi x1086 0 with true
                         then
                           lti x1086 (length12 params1)
                         else
                           false
                       with
                         true
                       then
                         log11 st714 (get params1 (subi (addi x1086 1) 1))
                       else
                         (st714, p_pure (log1 0.)))
                  (get x1471 (subi x1085 1))
              with
                (st715, x1087)
              in
              match
                p_map st715 (lam x1088.
                     addf 0. x1088) x1087
              with
                (st716, x1089)
              in
              match splitAt s226 1 with {#label"1" = x1090}
              in
              rec24 st716 x1471 samplingProb1 x1089 x1090
      ...
      lam repertoire21.
        ...
        then
          ...
          with
            (st711, x1079)
          in
          match splitAt repertoire21 1 with {#label"1" = x1080}
          in
          rec26 st711 x1079 x1080
        ...
        lam event31.
          lam nhosts71.
            ...
            with
              (st697, x1060)
            in
            match p_apply st697 x1058 x1060 with (st698, x1061)
            in
            match
              p_map
                st698
                (lam x1062.
                   match x1062 with Event1 x1442
                   then
                     x1442.toState
                   else
                     let #var"2146" =
            ...
            with
              (st704, x1068)
            in
            match p_map st704 subsequence x1068 with (st705, x1069)
            in
            match
              p_map st705 (lam x1070.
                   subi x1070 1) first1
            with
              (st706, x1073)
            in
            match p_apply st706 x1069 x1073 with (st707, x1074)
            in
            match
              p_map
                st707
                (lam x1075.
                   subi (addi nhosts71 1) x1075)
                first1
            with
              (st708, x1076)
            in
            match p_apply st708 x1074 x1076 with (st709, x1077)
            in
            paste02
              st709
              [ x1061,
        ...
        lam event3.
          lam nhosts7.
            ...
            with
              (st681, x1038)
            in
            match p_apply st681 x1036 x1038 with (st682, x1039)
            in
            match
              p_map
                st682
                (lam x1040.
                   match x1040 with Event1 x1441
                   then
                     x1441.toState
                   else
                     let #var"2144" =
            ...
            with
              (st686, first)
            in
            match p_map st686 subsequence currRep8 with (st687, x1045)
            in
            match
              p_map st687 (lam x1046.
                   subi x1046 1) first
            with
              (st688, x1047)
            in
            match p_apply st688 x1045 x1047 with (st689, x1048)
            in
            match
              p_map
                st689
                (lam x1049.
                   subi (addi nhosts7 1) x1049)
                first
            with
              (st690, x1050)
            in
            match p_apply st690 x1048 x1050 with (st691, x1053)
            in
            paste02
              st691
              [ x1039,
    ...
    let rec6 =
      lam st68.
        lam s5.
          ...
          (st68, "")
  in
  let sapply = lam st676.
      lam s92.
        rec6 st676 s92
  in
  let anon13 = lam x1030.
      eqi x1030 2 in
  let anon14 =
    lam st675.
      lam x1028.
        p_map st675 (lam x1029.
             eqi x1029 2) x1028
  in
  recursive
    let rec7 =
        ...
        lam hostIndex33.
          lam modelParams123.
              ...
              mtxGet
                ...
                (match
                   ...
                   then
                     ...
                     exit 1
                 with
                   EmbeddedMarkovChainMatrix1 x1404
                 then
                   x1404.mat
                 else
                   let #var"2140" =
            ...
            with
              (st673, baseRate13)
            in
            (st673, match eqi fromState53 0 with true
            then
              let dist4 =
                mtxMean
                  (mtxRowCols
        ...
        lam hostIndex32.
          lam modelParams122.
              ...
              mtxGet2
                ...
                (match
                   ...
                   then
                     ...
                     exit 1
                 with
                   EmbeddedMarkovChainMatrix1 x1403
                 then
                   x1403.mat
                 else
                   let #var"2136" =
            ...
            p_bind
              ...
              (lam st663.
                 lam x1021.
                   match eqi x1021 0 with true
                   then
                     match sapply st663 repertoire13 with (st664, x1022)
                     in
                     match whichTrue1 st664 x1022 with (st665, x1023)
                     in
                     match
                       mtxRowCols1
                         st665
                     ...
                     with
                       (st666, x1024)
                     in
                     match mtxMean1 st666 x1024 with (st667, dist3)
                     in
                     (st667, baseRate12)
                   else match sapply1 st663 repertoire13 with (st668, x1025)
                   in
                   match whichTrue1 st668 x1025 with (st669, x1026)
                   in
                   match
                     mtxRowCols1
                       st669
                   ...
                   with
                     (st670, x1027)
                   in
                   match mtxMean1 st670 x1027 with (st671, dist12)
                   in
                   (st671, baseRate12))
              fromState52
  in
        ...
        lam hostIndex31.
          lam modelParams121.
            ...
            with
              (st643, x1002)
            in
            match p_map st643 get x1002 with (st644, x1003)
            in
            match
              p_map
                st644
            ...
            with
              (st645, x1005)
            in
            match p_apply st645 x1003 x1005 with (st646, fromState51)
            in
            match
              p_map
                st646
              ...
              mtxGet2
                ...
                (match
                   ...
                   then
                     ...
                     exit 1
                 with
                   EmbeddedMarkovChainMatrix1 x1402
                 then
                   x1402.mat
                 else
                   let #var"2132" =
            ...
            p_bind
              ...
              (lam st650.
                 lam x1010.
                   match eqi x1010 0 with true
                   then
                     match sapply st650 repertoire12 with (st651, x1011)
                     in
                     match whichTrue1 st651 x1011 with (st652, x1012)
                     in
                     match
                       mtxRowCols2
                         st652
                     ...
                     with
                       (st653, x1013)
                     in
                     match mtxMean1 st653 x1013 with (st654, dist2)
                     in
                     (st654, baseRate11)
                   else match sapply1 st650 repertoire12 with (st655, x1014)
                   in
                   match whichTrue1 st655 x1014 with (st656, x1015)
                   in
                   match
                     mtxRowCols2
                       st656
                   ...
                   with
                     (st657, x1016)
                   in
                   match mtxMean1 st657 x1016 with (st658, dist11)
                   in
                   (st658, baseRate11))
              fromState51
  in
              ...
              mtxGet2
                ...
                (match
                   ...
                   then
                     ...
                     exit 1
                 with
                   EmbeddedMarkovChainMatrix1 x1401
                 then
                   x1401.mat
                 else
                   let #var"2128" =
                 ...
                 lam x988.
                   ...
                   then
                       ...
                       p_map
                         ...
                         (lam x989.
                            match x989 with [ _,
                                _ ] ++ _
                            then
                              match splitAt x989 1 with {#label"1" = x990}
                              in
                              cons (anon11 (get x989 0)) (rec5 x990)
                            else match x989 with [ e15 ]
                            then
                              match splitAt x989 1 with {#label"1" = x991}
                              in
                              let slice14 = x991 in
                              [ anon11 e15 ]
                            else match x989 with ""
                            in
                            "")
                         repertoire11
                     with
                       (st633, x992)
                     in
                     match whichTrue2 st633 x992 with (st634, x993)
                     in
                     ...
                     with
                       (st635, x994)
                     in
                     match mtxMean1 st635 x994 with (st636, dist)
                     in
                     (st636, baseRate1)
                   else match
                     p_map
                       ...
                       (lam x995.
                          match x995 with [ _,
                              _ ] ++ _
                          then
                            match splitAt x995 1 with {#label"1" = x996}
                            in
                            cons (anon13 (get x995 0)) (rec7 x996)
                          else match x995 with [ e16 ]
                          then
                            match splitAt x995 1 with {#label"1" = x997}
                            in
                            let slice15 = x997 in
                            [ anon13 e16 ]
                          else match x995 with ""
                          in
                          "")
                       repertoire11
                   with
                     (st637, x998)
                   in
                   match whichTrue2 st637 x998 with (st638, x999)
                   in
                   match
                     mtxRowCols2
                       st638
                   ...
                   with
                     (st639, x1000)
                   in
                   match mtxMean1 st639 x1000 with (st640, dist1)
                   in
                   (st640, baseRate1))
              fromState5
  in
        ...
        lam nodeLabel51.
          lam x897.
            ...
            with
              (st574, x903)
            in
            p_assume st574 (hrmStoreNode nodeLabel51 x897) x903
  in
  recursive
    let rec9 =
      lam st262.
                        ...
                        (lam st267.
                           lam x402.
                             match
                               ...
                               in
                               match p_assume st276 (hrmStoreBranchState nodeLabel host) x418 with (st277, nextState11)
                               in
                               match
                                 p_traverseSeq
                                   st277
                               ...
                               in
                               match p_assume st282 (hrmStoreBranchTime nodeLabel host) x427 with (st283, x428)
                               in
                               match
                                 p_map
                                   st283
                        ...
                        (lam st292.
                           lam x443.
                             match
                               ...
                               in
                               match p_assume st302 (hrmStoreBranchState nodeLabel1 host1) x460 with (st303, nextState12)
                               in
                               match
                                 p_traverseSeq
                                   st303
                               ...
                               in
                               match p_assume st308 (hrmStoreBranchTime nodeLabel1 host1) x469 with (st309, x470)
                               in
                               match
                                 p_map
                                   st309
              ...
              lam nodeLabel12.
                lam modelParams31.
                  lam x876.
                    ...
                    in
                    match p_assume st562 (hrmStoreBranchTime nodeLabel12 x876) x886 with (st563, x887)
                    in
                    match
                      p_map
                        st563
              ...
              lam nodeLabel11.
                lam modelParams3.
                  lam x858.
                    ...
                    in
                    match p_assume st550 (hrmStoreBranchTime nodeLabel11 x858) x867 with (st551, x868)
                    in
                    match
                      p_map
                        st551
  ...
  in
  match
    p_assume st485 hrmStoreMu (p_pure (mkExponential 10.))
  with
    (st486, mu)
  in
  match
    p_assume st486 hrmStoreBeta (p_pure (mkExponential 1.))
  with
    (st487, beta)
  in
