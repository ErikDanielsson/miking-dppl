lam st.
    ...
    lam st921.
      lam a51.
        lam b12.
          ...
          in
          match
            p_subApply st932 simpleStoreSubmodel (simpleInit {}) x1487 x1489
          with
            (st933, x1490)
          in
        ...
        lam mtx212.
          lam x1237.
            lam x1238.
              ...
              in
              match
                p_subApply st822 simpleStoreSubmodel (simpleInit {}) x1270 x1272
              with
                (st823, x1273)
              in
            ...
            lam interactions1.
              lam nhosts1.
                ...
                with
                  (st44, x45)
                in
                match mtxExpRateSafe st44 x45 with (st45, rightKernel)
                in
                match mtxTrans st45 leftKernel with (st46, x46)
                in
                match
                  mtxMul
                    st46
                    ...
                    lam nEvents3.
                      lam nhosts5.
                        lam modelParams.
                          ...
                          in
                          match
                            p_subApply st113 simpleStoreSubmodel (simpleInit {}) x136 x138
                          with
                            (st114, x139)
                          in
                    ...
                    lam nEvents31.
                      lam nhosts51.
                        lam modelParams1.
                          ...
                          in
                          match
                            p_subApply st135 simpleStoreSubmodel (simpleInit {}) x170 x172
                          with
                            (st136, x173)
                          in
        ...
        lam nodeLabel51.
          lam x893.
            ...
            with
              (st578, x898)
            in
            p_assume st578 simpleStoreAssume x898
  in
  recursive
    let rec9 =
      lam st270.
                        ...
                        (lam st275.
                           lam x408.
                             match
                               ...
                               in
                               match p_assume st284 simpleStoreAssume x423 with (st285, nextState11)
                               in
                               match
                                 p_traverseSeq
                                   st285
                               ...
                               in
                               match p_assume st290 simpleStoreAssume x432 with (st291, x433)
                               in
                               match
                                 p_map
                                   st291
                        ...
                        (lam st300.
                           lam x448.
                             match
                               ...
                               in
                               match p_assume st310 simpleStoreAssume x465 with (st311, nextState12)
                               in
                               match
                                 p_traverseSeq
                                   st311
                               ...
                               in
                               match p_assume st316 simpleStoreAssume x474 with (st317, x475)
                               in
                               match
                                 p_map
                                   st317
              ...
              lam nodeLabel12.
                lam modelParams31.
                  lam x872.
                    ...
                    in
                    match p_assume st566 simpleStoreAssume x882 with (st567, x883)
                    in
                    match
                      p_map
                        st567
              ...
              lam nodeLabel11.
                lam modelParams3.
                  lam x854.
                    ...
                    in
                    match p_assume st554 simpleStoreAssume x863 with (st555, x864)
                    in
                    match
                      p_map
                        st555
                ...
                lam parentAge.
                  lam modelParams11.
                    lam branchKernel.
                                       ...
                                       p_bind
                                         ...
                                         (lam st391.
                                            lam x615.
                                              ...
                                              in
                                              match
                                                p_subApply st399 simpleStoreSubmodel (simpleInit {}) x623 x625
                                              with
                                                (st400, x626)
                                              in
                                     ...
                                     p_bind
                                       ...
                                       (lam st451.
                                          lam x712.
                                            ...
                                            in
                                            match
                                              p_subApply st459 simpleStoreSubmodel (simpleInit {}) x720 x722
                                            with
                                              (st460, x723)
                                            in
                      ...
                      in
                      match mtxCreate1 st483 nHosts 3 x764 with (st484, newMsg)
                      in
                      match
                        mtxMul
                          st484
  ...
  in
  match
    p_assume st490 simpleStoreAssume (p_pure (mkExponential 10.))
  with
    (st491, mu)
  in
  match
    p_assume st491 simpleStoreAssume (p_pure (mkExponential 1.))
  with
    (st492, beta)
  in
  match
  ...
  in
  match mtxCreate1 st527 nHosts1 3 x821 with (st528, newMsg1)
  in
